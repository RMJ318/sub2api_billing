...
- [ ] 3. Implement CSV field codecs, row parser, and serializer
  ...
  - [ ] 3.5 Write property test for stream boolean codec
  ...
  - [ ] 3.8 Write property test for invalid row rejection
    - **Property 7: Invalid rows are rejected and report every failing field**
    - **Validates: Requirements 2.9, 2.10**

  - [ ] 3.9 Implement CSV record serializer
  ...
  - [ ] 3.10 Write property test for CSV serialize/parse round-trip
...
- [ ] 6. Implement Dashboard KPI computation
...
- [ ] 7. Implement trend, scatter, sorting, search, and date-range helpers
  ...
  - [ ] 7.2 Write property test for time-bucketed trends
  ...
  - [ ] 7.4 Write property test for scatter mapping
...
- [ ] 8. Implement budget, Pareto, and forecast logic
  ...
  - [ ] 8.4 Write property test for Pareto shares
    - **Property 28: Pareto cumulative shares are monotonic and bounded**
    - **Validates: Requirements 14.1**

  - [ ] 8.5 Implement `forecastMonthEnd`
  ...
  - [ ] 8.6 Write property test for month-end forecast
    - **Property 29: Month-end forecast extrapolates the daily rate**
    - **Validates: Requirements 14.2, 14.3, 14.4**

- [ ] 9. Implement key health and reconciliation logic
  - [ ] 9.1 Implement key health classifiers
  ...
  - [ ] 9.2 Write property test for long-unused keys
    - **Property 30: Long-unused keys are exactly those idle beyond 14 days**
    - **Validates: Requirements 12.4**

  - [ ] 9.3 Write property test for abnormal-growth keys
    - **Property 31: Abnormal-growth keys exceed the 200 percent threshold**
    - **Validates: Requirements 12.6**

  - [ ] 9.4 Implement reconciliation and unmatched-reference detection
  ...
  - [ ] 9.5 Write property test for daily-to-monthly reconciliation
    - **Property 32: Daily records reconcile to the monthly summary**
    - **Validates: Requirements 21.1, 21.2**

  - [ ] 9.6 Write property test for unmatched API key references
...
- [ ] 11. Implement Insight Engine
  - [ ] 11.1 Implement `topPerformers` and `trendInsights`
...
- [ ] 12. Implement Signal Engine
  - [ ] 12.1 Implement `detectSignals` rules
...
- [ ] 15. Implement Ingestion Service
  ...
  - [ ] 15.3 Implement ingestion orchestration over discovered folders
  ...
  - [ ] 15.4 Write integration tests for folder discovery scenarios
  ...
  - [ ] 15.5 Implement streaming loader for `request_detail.csv`
  ...
  - [ ] 15.6 Write integration test for bounded-memory streaming ingestion
